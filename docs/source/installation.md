...
This guide explains how to deploy the Auction App backend and frontend using Node.js, Apache and Let's Encrypt for free HTTPS certificates. It assumes an Ubuntu comamnd style (developed on Mint & Ubuntu).
